...
void CenterFrame::createUserCommandArea()
{
    ...
    QRect sourceRect=pic.rect();
    painter.drawImage(targetRect,pic,sourceRect);
    ...
    gridLayout->addWidget(btnPic,2,1);
...
void CenterFrame::on_btnPicClicked()
{
    ...
    filename=QFileDialog::getOpenFileName(this,
                                          tr("选择图像"),
                                          "F:/Qthomework/lab02/pic/5d175890f603738dde97b7c7bf1bb051f919ec09.jpg",
    ...
    else
    {
        ...
        btnPic->setIcon(QPixmap::fromImage(*img));
    }*/
    if(btnPic->isChecked()){
